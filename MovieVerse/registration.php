...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (!$error) {
    ...
    echo "prepared stmt";
    $insert->bind_param("sssss", $firstname, $lastname, $email, $password, $username);
    if ($insert->execute()) {
...
<div class="container col-xs-10 col-lg-6 mt-3">
  <form action="registration.php" method="POST" class="row g-3 needs-validation" novalidate>
    <div class="fs-2 mt-3 text-center">Sign Up</div>
    <div class="text-center">Already a user? <a href="login.php" style="color:#8294C4"> LOGIN</a></div>
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" value="<?PHP /*if(!empty($_POST["firstname"])){echo $_POST["firstname"];} */ ?>" id="validationCustom02" placeholder="First name" name="firstname">
      <div class="invalid-feedback">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" value="<?PHP /* if(!empty($_POST["lastname"])){echo $_POST["lastname"];} */ ?>" id="validationCustom03" placeholder="Last name" name="lastname">
      <div class="invalid-feedback">
    ...
    <div class="col-md-6">
      ...
      <input type="email" class="form-control" value="<?PHP /* if(!empty($_POST["email"])){echo $_POST["email"];} */ ?>" id="validationCustom04" placeholder="example@gmail.com" name="email">
      <div class="invalid-feedback">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" value="<?PHP /* if(!empty($_POST["username"])){echo $_POST["username"];} */ ?>" id="validationCustom05" placeholder="User name" name="username">
      <div class="invalid-feedback">
    ...
    <div class="col-md-6">
      ...
      <input type="password" class="form-control" id="inputRepeatPassword4" placeholder="Repeat password" name="pwdconfirm">
      <div class="invalid-feedback">
