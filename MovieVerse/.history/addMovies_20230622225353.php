...
// Validate inputs - if any of them are empty, return an error message and stop the script
if (empty($_POST["title"]) || empty($_POST["duration"]) || empty($_POST["genre"]) || empty($_POST["cast"]) || empty($_POST["ratings"]) || empty($_POST["review"]) || empty($_POST["description"])) {
