                ...
                <div class="col-lg-3 mb-2">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="add_to_favorites.php?movie_id=' . $row["id"] . '" class="btn btn-primary btn-sm">Favourites</a>
                            <a href="add_to_watched.php?movie_id=' . $row["id"] . '" class="btn btn-primary btn-sm">Watched</a>
                            <a href="add_to_watch_later.php?movie_id=' . $row["id"] . '" class="btn btn-primary btn-sm">To Be Watched</a>
                        </div>
                    </div>
                </div>
            ';
