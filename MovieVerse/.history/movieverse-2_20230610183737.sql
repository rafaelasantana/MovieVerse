...
INSERT INTO `movie` (`titel`, `duration`, `genre`, `cast`, `ratings`, `review`, `description`) VALUES
('test', 'test', 'test', 'test', '5', 'test', 'test'),
('a', 'a', 'a', 'a', '1', 'a', 'a');
...
(2, 'a', 'a', 'a@a.com', 'a', 0, '$2y$10$ohVfG.ESvYD2clVwzLz0keNv.husJ6VhxF.AtCeW.9YTeh136HMni'),
(3, 'b', 'b', 'b@b.com', 'b', 0, '$2y$10$KlsDr9uiptat/luykGaoGOw9kw3El9na5Z5fb9WgPGIVN/Bvvuax.'),
