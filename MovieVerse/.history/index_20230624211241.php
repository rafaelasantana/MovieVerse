...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo '
            <div class="col-lg-4 mb-1 justify-content-center">
                <div class="card" style="max-width: 300px;">
                    <img class="card-img-top" src="'.htmlspecialchars($row['coverImage']).'" alt="Cover Image" style="width: 300px; height: 320px; object-fit: cover;">
                    <div class="card-body">
