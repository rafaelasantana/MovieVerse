...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["review"])) {
    ...
    $ratings = intval($_POST["ratings"]); // Convert ratings to an integer
    if ($ratings <= 0) {
      $errors["ratings"] = "Ratings must be a positive integer";
    }
    $review = $_POST["review"];
  }
...
<body>
  ...
  <div class="container col-xs-10 col-lg-6 mt-3">
    <form action="addMovies.php" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
      ...
      <div class="col-md-12">
        ...
        <input type="number" class="form-control" id="validationCustom05" placeholder="Ratings" name="ratings" required min="1">
