        ...
        <div id="navbar_index" class="collapse navbar-collapse justify-content-end">
            <div class="navbar-nav">
                ...
                if (isset($_SESSION["firstname"])) { ?>
                    ...
                    <a class='navbar-text nav-link <?php if($page == 'addMovies') echo 'active' ?>' href='addMovies.php'>Add Movie</a>
                ...
                // if user is not logged in, show register and login
                    ...
                    <a class="navbar-text nav-link <?php if ($page == "registration") echo "active" ?>" href="registration.php">Sign Up</a>
